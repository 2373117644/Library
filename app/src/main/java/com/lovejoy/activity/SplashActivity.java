...
import com.lovejoy.adapter.ViewPagerAdapter;
...
public class SplashActivity extends Activity implements OnPageChangeListener{
	...
	private void initViews()
	{
	    ...
	    views.add(inflater.inflate(R.layout.start_first, null));
	    views.add(inflater.inflate(R.layout.start_second, null));
	    views.add(inflater.inflate(R.layout.start_third, null));
